    ...
    <form className="flex flex-col space-y-5 items-center">
      ...
      <div className="text-gray-700">
        <p className="mb-4">
          ...
          1. Enter a query below toSearch millions of podcasts via Podchaser API.<br />
          2. Click on a search result and then pick an episode to transcribe.<br />
          3. View the final HTML transcript result!</strong>
        </p>
        <p className="mb-1">
